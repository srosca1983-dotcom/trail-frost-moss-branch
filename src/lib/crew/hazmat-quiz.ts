...
export const HAZMAT_CFR = "49 CFR 172.700–704 · 49 CFR 176.13 · IMDG 1.3";
export const HAZMAT_PASS = 16;
export const HAZMAT_VALIDITY_YEARS = 3;

export type HazmatElement = "awareness" | "function" | "safety" | "security" | "record";

export type HazmatChoice = { key: "A" | "B" | "C" | "D"; text: string };

export type HazmatQuestion = {
  n: number;
  element: HazmatElement;
  prompt: string;
  choices: HazmatChoice[];
  answer: "A" | "B" | "C" | "D";
  why: string;
};

export const HAZMAT_QUESTIONS: HazmatQuestion[] = [
  {
    n: 1,
    element: "awareness",
    prompt: "49 CFR 172.704 requires hazmat training in which set of elements?",
    choices: [
      { key: "A", text: "Firefighting, first aid, and radar only" },
      { key: "B", text: "General awareness, function-specific, safety, and security awareness (in-depth security only if you have security-plan duties)" },
      { key: "C", text: "ISM familiarization and SASH only" },
      { key: "D", text: "A toolbox talk at the start of each voyage" },
    ],
    answer: "B",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "Every calendar year" },
      { key: "B", text: "Every 5 years with STCW basic training" },
      { key: "C", text: "At least once every 3 years" },
      { key: "D", text: "Only when the SMS is revised" },
    ],
    answer: "C",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "Only the Master" },
      { key: "B", text: "Anyone who loads, unloads, handles, stows, or supervises dangerous cargo, or who is responsible for its safety in transport" },
      { key: "C", text: "Only people with a tankerman endorsement" },
      { key: "D", text: "Steward department only, because of ship’s stores" },
    ],
    answer: "B",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "Trained only — a sign-in sheet is enough" },
      { key: "B", text: "Trained and tested, and a record kept" },
      { key: "C", text: "Given a copy of the IMDG Code" },
      { key: "D", text: "Licensed by PHMSA as a shipper" },
    ],
    answer: "B",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "The employee’s name and the most recent training date" },
      { key: "B", text: "A description, copy, or location of the training materials" },
      { key: "C", text: "The employee’s home address and next of kin" },
      { key: "D", text: "Name and address of the trainer, and a certification that the person was trained and tested" },
    ],
    answer: "C",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "Explosives" },
      { key: "B", text: "Gases" },
      { key: "C", text: "Flammable liquids" },
      { key: "D", text: "Radioactive material" },
    ],
    answer: "C",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "Flammable gas" },
      { key: "B", text: "Non-flammable, non-toxic gas" },
      { key: "C", text: "Toxic gas" },
      { key: "D", text: "Organic peroxide" },
    ],
    answer: "A",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "The ship’s funnel" },
      { key: "B", text: "Inner packages / drums inside the container, and some packages that move as packages" },
      { key: "C", text: "The Master’s office door" },
      { key: "D", text: "Only empty tanks" },
    ],
    answer: "B",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "The ship’s IMO number" },
      { key: "B", text: "The specific dangerous good, so you can look up stowage, segregation, and emergency schedules" },
      { key: "C", text: "The container’s CSC approval" },
      { key: "D", text: "The voyage number" },
    ],
    answer: "B",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "Which union hall the mariner came from" },
      { key: "B", text: "Great danger, medium danger, and minor danger of the substance" },
      { key: "C", text: "On-deck, under-deck, and magazine stowage" },
      { key: "D", text: "The three watches" },
    ],
    answer: "B",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "Ship’s stores only — ignore it at sea" },
      { key: "B", text: "The cargo is a marine pollutant; treat spills as a threat to the sea and follow the DG papers / MARPOL" },
      { key: "C", text: "The box is empty and gas-free" },
      { key: "D", text: "The cargo is food-grade" },
    ],
    answer: "B",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "Class 8 acids next to Class 5.1 oxidizers or Class 4.3 water-reactives without checking the table" },
      { key: "B", text: "Any two containers on the same bay" },
      { key: "C", text: "Reefer boxes on deck" },
      { key: "D", text: "Empty containers forward of the house" },
    ],
    answer: "A",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "Stowed under deck in the engine room" },
      { key: "B", text: "Stowed as the IMDG / cargo plan requires — often on deck, clear of accommodation, with the permitted quantities" },
      { key: "C", text: "Kept in the paint locker" },
      { key: "D", text: "Carried only if the bosun agrees" },
    ],
    answer: "B",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "May be discarded after sailing" },
      { key: "B", text: "Must be kept on board, readily available, and list UN number, class, stowage location, and quantity" },
      { key: "C", text: "Is only for the agent ashore" },
      { key: "D", text: "Is the same document as the CSC plate" },
    ],
    answer: "B",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "The union contract" },
      { key: "B", text: "The IMDG EmS fire/spill schedules and the Emergency Response Guidebook (or equivalent shipboard ERG)" },
      { key: "C", text: "The cyber incident plan" },
      { key: "D", text: "The crew list" },
    ],
    answer: "B",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "Class 3 flammable liquids in all cases" },
      { key: "B", text: "Class 4.3 dangerous when wet — water-reactive substances" },
      { key: "C", text: "Class 9 miscellaneous" },
      { key: "D", text: "Marine pollutants" },
    ],
    answer: "B",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "Are not dangerous and may be stowed anywhere" },
      { key: "B", text: "Are still dangerous goods, but packed in small inner packagings with reduced marks — still follow the cargo papers" },
      { key: "C", text: "May only be carried by aircraft" },
      { key: "D", text: "Do not need a UN number in the papers" },
    ],
    answer: "B",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "Carriage by aircraft" },
      { key: "B", text: "Carriage by rail" },
      { key: "C", text: "Carriage by vessel" },
      { key: "D", text: "Highway only" },
    ],
    answer: "C",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "Open the doors to ventilate without checking the class" },
      { key: "B", text: "Keep people upwind/uphill, raise the alarm, identify the UN number from the placard/papers, then follow EmS / the Master’s orders" },
      { key: "C", text: "Wash it straight overboard in every case" },
      { key: "D", text: "Ignore it until the next port" },
    ],
    answer: "B",
  ...
  },
  {
    ...
    choices: [
      { key: "A", text: "Leave the DG manifest on the gangway so the agent can grab it" },
      { key: "B", text: "Control access to DG papers and cargo spaces, report unexplained interest in the boxes, and follow the vessel security plan — do not peel placards" },
      { key: "C", text: "Only the bosun needs to know what is on board" },
      { key: "D", text: "Hide class 1 boxes by covering the marks" },
    ],
    answer: "B",
...
export const HAZMAT_STUDY: Array<{ heading: string; lines: string[] }> = [
  {
...
export function parseHazmatScore(text: string | null | undefined): number | null {
  if (!text) return null;
...
export function passedHazmat(score: number): boolean {
  return Number.isFinite(score) && score >= HAZMAT_PASS && score <= HAZMAT_QUESTIONS.length;
}

export function classifyHazmatSeat(p: HazmatCrewInput): HazmatSeat {
...
export function classifyHazmatCrew(list: HazmatCrewInput[]): HazmatSeat[] {
  return list
    .filter((p) => p.status == null || p.status === "current")
    .map(classifyHazmatSeat)
    .sort((a, b) => Number(b.required) - Number(a.required) || a.lastName.localeCompare(b.lastName));
}

export function requiredHazmatSeats(seats: HazmatSeat[]): HazmatSeat[] {
