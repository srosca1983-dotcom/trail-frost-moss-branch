...
/** Which database backend is active. Re-eval glob so 0004_permanents.sql applies. */
...
async function createPgliteSql(): Promise<Sql> {
  ...
  globalRef.__pgliteInstance__ ??= (async () => {
    ...
    const persistDir =
      process.env.PGLITE_DATA_DIR || (process.env.VERCEL ? undefined : "/workspace/.pglite-data");
  ...
  // double-apply. Includes 0005_extra_days.sql and 0006_rotary_leave.sql.
