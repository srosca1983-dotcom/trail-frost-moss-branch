//#region node_modules/.nitro/vite/services/ssr/assets/nse-D-shPCWK.js
var NSE_KINDS = [
	"sash",
	"fam",
	"cyber",
...
var NSE_SOURCE = "NS5 Permanents sheet";
...
function isNsePlaceholder(issued) {
	return Boolean(issued?.startsWith("1990"));
}
function nseDocuments(id) {
	const row = NSE_TRAINING[id];
	if (!row) return [];
	return Object.keys(row).flatMap((k) => {
		const pair = row[k];
		if (!pair) return [];
...
//#endregion
export { NSE_SOURCE as a, nseDocuments as c, NSE_SHORT as i, NSE_KINDS as n, NSE_VALIDITY_YEARS as o, NSE_LABELS as r, isNsePlaceholder as s, NSE_CODES as t };
